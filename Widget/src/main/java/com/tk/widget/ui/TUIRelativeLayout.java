    ...
    private void initAttr(@Nullable AttributeSet attrs) {
        if (attrs == null) {
            ...
            uiHelper = new TUIHelper.Builder<IView>(this, typedArray)
                    ...
                    .bgGradientDirectionPressed(R.styleable.TUIRelativeLayout_tui_bg_gradientEndColor_pressed)
                    .bgGradientDirectionSelected(R.styleable.TUIRelativeLayout_tui_bg_gradientEndColor_selected)
                    .bgGradientDirectionFocused(R.styleable.TUIRelativeLayout_tui_bg_gradientEndColor_focused)
                    .bgGradientDirectionDisabled(R.styleable.TUIRelativeLayout_tui_bg_gradientEndColor_disabled)
                    .build();
