...
public class TUIButton extends AppCompatButton implements ITextView {
    ...
    private void initAttr(@Nullable AttributeSet attrs) {
        if (attrs == null) {
            ...
            uiHelper = new TUIHelper.Builder<ITextView>(this, typedArray)
                    ...
                    .bgGradientDirectionPressed(R.styleable.TUIButton_tui_bg_gradientEndColor_pressed)
                    .bgGradientDirectionSelected(R.styleable.TUIButton_tui_bg_gradientEndColor_selected)
                    .bgGradientDirectionFocused(R.styleable.TUIButton_tui_bg_gradientEndColor_focused)
                    .bgGradientDirectionDisabled(R.styleable.TUIButton_tui_bg_gradientEndColor_disabled)
