    ...
    private void initAttr(@Nullable AttributeSet attrs) {
        if (attrs == null) {
            ...
            uiHelper = new TUIHelper.Builder<IView>(this, typedArray)
                    ...
                    .bgGradientDirectionPressed(R.styleable.TUIView_tui_bg_gradientEndColor_pressed)
                    .bgGradientDirectionSelected(R.styleable.TUIView_tui_bg_gradientEndColor_selected)
                    .bgGradientDirectionFocused(R.styleable.TUIView_tui_bg_gradientEndColor_focused)
                    .bgGradientDirectionDisabled(R.styleable.TUIView_tui_bg_gradientEndColor_disabled)
                    .build();
