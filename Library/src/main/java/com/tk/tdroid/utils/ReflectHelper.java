...
public final class ReflectHelper {
    ...
    private ReflectHelper(final Class<?> type) {
        this(type, type);
    }
     ...
     * @return the single {@link ReflectHelper} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectHelper reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectHelper reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectHelper reflect(final Class<?> clazz)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectHelper reflect(final Object object)
            throws ReflectException {
        return new ReflectHelper(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link ReflectHelper} instance
     */
    public ReflectHelper newInstance() {
     ...
     * @return the single {@link ReflectHelper} instance
     */
    public ReflectHelper newInstance(Object... args) {
    ...
    private ReflectHelper newInstance(final Constructor<?> constructor, final Object... args) {
        try {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public ReflectHelper method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public ReflectHelper method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private ReflectHelper method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof ReflectHelper && object.equals(((ReflectHelper) obj).get());
    }
