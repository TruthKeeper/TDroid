...
public class TUITextView extends TextView implements ITextView {
    ...
    private void initAttr(@Nullable AttributeSet attrs) {
        if (attrs == null) {
            ...
            uiHelper = new TUIHelper.Builder<ITextView>(this, typedArray)
                    ...
                    .bgGradientDirectionPressed(R.styleable.TUITextView_tui_bg_gradientDirection_pressed)
                    .bgGradientDirectionSelected(R.styleable.TUITextView_tui_bg_gradientDirection_selected)
                    .bgGradientDirectionFocused(R.styleable.TUITextView_tui_bg_gradientDirection_focused)
                    .bgGradientDirectionDisabled(R.styleable.TUITextView_tui_bg_gradientDirection_disabled)
