...
public class SampleSaveActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample_save);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((SampleSaveFragment) getSupportFragmentManager().findFragmentById(R.id.fragment)).init();
            }
        });
    }
